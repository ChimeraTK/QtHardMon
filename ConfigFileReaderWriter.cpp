...
//    std::cout << std::endl;
    ...
    else if (variableType == "int")
    {
      ...
      // The 0 as last argument is the base. 0 also allows to read 0xNNN as hex and 0NNN as octal.
...
void ConfigFileReaderWriter::write( std::string const & fileName ) const
{
 ...
 // let's have a nice header
  ...
  // Is this needed? The stream goes out of scope anyway and should close the file.
  outFileStream.close();
}
