...
RegisterPropertiesWidget::RegisterPropertiesWidget(QWidget *parent)
    : PropertiesWidget(parent), ui(new Ui::RegisterPropertiesWidget) {
  ui->setupUi(this);
  clearFields();
...
RegisterPropertiesWidget::~RegisterPropertiesWidget() { delete ui; }
...
void RegisterPropertiesWidget::setFixedPointInfo(int width, int fracBits,
                                                 int signBit) {
