...
MultiplexedAreaPropertiesWidget::MultiplexedAreaPropertiesWidget(
    QWidget *parent)
    : PropertiesWidget(parent), ui(new Ui::MultiplexedAreaPropertiesWidget) {
  ui->setupUi(this);
  clearFields();
}
...
void MultiplexedAreaPropertiesWidget::setNames(
...
void MultiplexedAreaPropertiesWidget::setFixedPointInfo(int /* width */,
                                                        int /* fracBits */,
                                                        int /* signBit */) {}
