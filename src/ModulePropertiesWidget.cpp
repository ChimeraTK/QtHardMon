...
ModulePropertiesWidget::ModulePropertiesWidget(QWidget *parent)
    : PropertiesWidget(parent), ui(new Ui::ModulePropertiesWidget) {
  ui->setupUi(this);

  clearFields();
}

ModulePropertiesWidget::~ModulePropertiesWidget() { delete ui; }
...
void ModulePropertiesWidget::setFixedPointInfo(int /* width */,
                                               int /* fracBits */,
                                               int /* signBit */) {
