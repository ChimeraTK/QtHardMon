...
void PropertiesWidgetProvider::registerWidget(const int type, PropertiesWidget * widget, int page) {
    registeredWidgets_[type] = widget;
    registeredPages_[type] = page;
}

void PropertiesWidgetProvider::registerWidget(DeviceElementDataType type, PropertiesWidget * widget, int page) {
