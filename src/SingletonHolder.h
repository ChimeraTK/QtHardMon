...
T *SingletonHolder<T, CreationPolicy, LifetimePolicy, ThreadingModel,
                   V>::pInstance = NULL;

template <class T, template <class> class CreationPolicy,
          template <class> class LifetimePolicy,
          template <class> class ThreadingModel, int V>
bool SingletonHolder<T, CreationPolicy, LifetimePolicy, ThreadingModel,
                     V>::destroyed = false;
...
//==============================================================================
template <class T> class CreateByNew {
public:
  static T *Create() { return new T; }
  static void Destroy(T *pObj) { delete pObj; }
};
//==============================================================================
template <class T> class SingleThread {
public:
  class Lock {};
};
//==============================================================================
...
//==============================================================================
template <class T> class LifetimeStandard {
public:
  static void ScheduleDestruction(void (*pFun)(void)) { atexit(pFun); }
  static void OnDeadReference() {
    throw std::runtime_error(
        "Internal error: dead reference in singleton class");
  }
};
//==============================================================================
