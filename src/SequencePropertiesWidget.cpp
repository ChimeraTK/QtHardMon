...
SequencePropertiesWidget::SequencePropertiesWidget(QWidget *parent) :
    ...
    ui(new Ui::SequencePropertiesWidget)
{
    ui->setupUi(this);
    clearFields();
...
SequencePropertiesWidget::~SequencePropertiesWidget()
{
    delete ui;
}
...
void SequencePropertiesWidget::setRegisterProperties(RegisterProperties properties) {
...
void SequencePropertiesWidget::setFixedPointInfo(int width, int fracBits, int signBit) {
