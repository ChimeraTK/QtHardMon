...
void PropertiesWidget::updateRegisterInfo(
  ...
  setEnabled(true);
  ui.registerPathDisplay->setText(
      static_cast<const std::string &>(registerInfo->getRegisterName())
          .c_str());
  ...
  auto numericAddressedInfo =
      boost::dynamic_pointer_cast<ChimeraTK::RegisterInfoMap::RegisterInfo>(
          registerInfo);
...
void PropertiesWidget::setShape(unsigned int nDimensions,
...
void PropertiesWidget::setType(
    ChimeraTK::RegisterInfo::DataDescriptor const &dataDescriptor) {
...
void PropertiesWidget::setFixedPointInfo(int width, int nFracBits,
                                         bool signedFlag,
