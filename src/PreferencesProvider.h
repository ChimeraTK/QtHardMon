...
public:
  template <typename T> void setValue(QString key, T value);
...
template <typename T> T PreferencesProvider::getValue(QString key) {
...
typedef SingletonHolder<PreferencesProvider, CreateByNew, LifetimeStandard,
                        SingleThread>
    PreferencesProviderSingleton;
