...
template <class USER_DATA_TYPE>
QVariant RegisterTypeAbstractorImpl<USER_DATA_TYPE>::data(
...
template <class USER_DATA_TYPE>
ChimeraTK::DataType
RegisterTypeAbstractorImpl<USER_DATA_TYPE>::rawDataType() const {
  return _rawDataType;
}
...
qvariantToStandardDataType<std::string>(const QVariant &data);

template <>
QVariant
RegisterTypeAbstractorImpl<std::string>::data(unsigned int channelIndex,
...
template <>
QVariant
RegisterTypeAbstractorImpl<int64_t>::data(unsigned int channelIndex,
                                          unsigned int elementIndex) const;
template <>
QVariant
RegisterTypeAbstractorImpl<uint64_t>::data(unsigned int channelIndex,
                                           unsigned int elementIndex) const;
